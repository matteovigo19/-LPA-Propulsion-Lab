...
% Rapporto di espansione dell'ugello (rocket)
epsilon = 200;
...
% VETTORI O/F
%
% Ogni ossidante ha il proprio intervallo.
% ============================================================
...
% Raccolta dei vettori in una cell array
OF_all = { ...
    OF_LOX, ...
    OF_GOX, ...
    OF_H2O2, ...
...
% Isp è una cell array perché i vettori O/F hanno lunghezze diverse
...
for i = 1:N_ossidanti
    ...
    for j = 1:length(OF_current)
        ...
        % isp(2) = uscita
        %
        % Per il confronto utilizziamo l'uscita.
        % ------------------------------------------------------
...
for i = 1:N_ossidanti
    ...
    plot( ...
        ...
        'Marker',marker{i}, ...
        'MarkerSize',7, ...
        'MarkerIndices',1:5:length(OF_all{i}), ...
...
title(sprintf( ...
    'HTPB - I_{sp} vs O/F - p_c = %.1f bar',pc))
