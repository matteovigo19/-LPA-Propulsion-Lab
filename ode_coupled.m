...
% ============================================================
% La refine viene usata solo se:
%   1. plot_case == "refined"
%   2. la geometria è ancora stellata
%
% Quando la geometria è quasi cilindrica, la refine viene spenta,
% perché il criterio sulle punte interne non ha più senso.
...
switch plot_case
    ...
    if mesh_mode == "star"
        ...
        % In modalità cilindrica tengo comunque attiva la camera
        [P_eval, ~] = refine_mesh_camera(P_eval, D_camera);
