...
vars.geometry.ntips = 9;

% Mesh in SI: metri
vars.geometry.diametro_est = 1.8e-1;    % [m]
vars.geometry.diametro_int = 9e-2;     % [m]
...
[t_ode, y_in_time, t_event, y_event, i_event] = ode45(odefun, tspan, y0, options);
